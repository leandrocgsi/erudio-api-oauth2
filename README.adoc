...
image::https://circleci.com/gh/leandrocgsi/erudio-api-oauth2.svg?&style=shield?branch=master[Build Status, link=https://circleci.com/gh/leandrocgsi/erudio-api-oauth2/]

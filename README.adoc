...
* http://community.jaspersoft.com/[Jasper Reports]
...
image::https://github.com/leandrocgsi/erudio-api-oauth2/blob/master/img/SwaggerDocumentation.png?raw=true[Example Page]
